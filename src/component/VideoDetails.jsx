    ...
    <>
      <div className="flex justify-center flex-row h-[calc(100% - 56px)] bg-black ">
        <div className="w-full max-w-[1280px] flex flex-col lg:flex-row ">
          <div className="flex flex-col lg:w-[calc(100% - 350px)] xl:w-[calc(100% - 400px)] px-4 py-3 lg:py-6 overflow-y-auto ">
            ...
            <div className="flex justify-between flex-col md:flex-row mt-4 ">
              ...
              <div className="flex text-white mt-4 md:mt-0 ">
                ...
                <div
                  className="flex items-center justify-center h-11 px-6 rounded-3xl
                 bg-white/[0.15] ml-4 cursor-pointer "
                >
                  <AiOutlineLike className=" text-xl text-white mr-2 " />
                  <span>
          ...
          <div className="flex flex-col MAJIDKHAN py-6 px-4 overflow-y-auto lg:w-[350px] xl:w-[400px] ">
            {relatedVideos?.contents?.map((item, i) => {
              if (item.type !== "video") return false;

              return <SuggestionVideo key={i} video={item?.video} />;
            })}
          </div>
        </div>
      </div>
